...
class CircleBox extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(const Rect.fromLTRB(3, 3, 117, 117), 3 * math.pi / 2, -math.pi * 1.5, false, paintInside);
    ...
    var paint = Paint()
      ...
      canvas.drawArc(const Rect.fromLTRB(0, 0, 120, 120), 3 * math.pi / 2, -math.pi * 1.5, false, paint);
      canvas.drawArc(const Rect.fromLTRB(6, 6, 114, 114), 3 * math.pi / 2, -math.pi * 1.5, false, paint);
